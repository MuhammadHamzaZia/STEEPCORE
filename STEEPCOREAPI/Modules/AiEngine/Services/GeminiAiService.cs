...
public class GeminiAiService : IAiService
{
    ...
    private const string GeminiGenerateApiUrl = "https://generativelanguage.googleapis.com/v1beta/models/gemini-3.8-flash:generateContent"; private const string SystemPrompt = @"You are an expert curriculum designer and senior industry architect. 
