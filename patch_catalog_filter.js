...
// Make sure to remove the old ones to avoid duplicates
...
// Replace UI elements for Category Type
code = code.replace(
...
// Replace UI elements for Industry
code = code.replace(
...
// Replace UI elements for Domain
code = code.replace(
...
console.log('patched catalog arrays');
